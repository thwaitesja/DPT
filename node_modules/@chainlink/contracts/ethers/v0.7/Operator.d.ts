...
interface OperatorInterface extends Interface {
  functions: {
    ...
    getForwarders: TypedFunctionDescription<{ encode([]: []): string }>;
  ...
  events: {
    AuthorizedSendersChanged: TypedEventDescription<{
      encodeTopics([senders]: [null]): string[];
    }>;
    ...
    ForwarderCreated: TypedEventDescription<{
      encodeTopics([addr]: [string | null]): string[];
    }>;
...
export class Operator extends Contract {
  ...
  functions: {
    ...
    getForwarders(overrides?: TransactionOverrides): Promise<string[]>;
  ...
  filters: {
    AuthorizedSendersChanged(senders: null): EventFilter;

    CancelOracleRequest(requestId: Arrayish | null): EventFilter;

    ForwarderCreated(addr: string | null): EventFilter;
  ...
  estimate: {
    ...
    getForwarders(overrides?: TransactionOverrides): Promise<BigNumber>;
